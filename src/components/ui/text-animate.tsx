...
const TextAnimate: FC<Props> = ({
  ...
  once: true,
  margin: "-80% 0px -20% 0px", // Triggers when element enters the top 20% (1/5) of the viewport
})
  ...
  if (type === "rollIn" || type === "whipIn") {
    return (
      <h2 className=" text-3xl font-white text-white dark:text-neutral-100 md:text-5xl">
  ...
  return (
    <motion.h2
      ...
      initial="hidden"
      animate={ctrls}
      className="text-4xl font-white text-white dark:text-neutral-100 md:text-5xl"
      {...props}
    >
